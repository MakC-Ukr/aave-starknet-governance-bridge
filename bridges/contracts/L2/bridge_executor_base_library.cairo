...
from contracts.L2.interfaces.i_executor_base import ActionsSet, User, Call
...
namespace BridgeExecutorBaseLibrary {
    ...
    func get_delay{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
        res: felt
    ) {
        let res = _delay.read();
        return (res);
    ...
    func update_guardian{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        new_guardian: felt
    ) {
    ...
    func update_grace_period{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        new_gp: felt
    ) {
    ...
    func update_minimum_delay{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        new_md: felt
    ) {
    ...
    func update_maximum_delay{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        new_md: felt
    ) {
    ...
    func get_actions_set_example{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        id: felt
    ) -> (res: ActionsSet) {
        alloc_locals;
        let (targets_len_) = 2;
    ...
    func execute_actions_set{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        id: felt
    ) {
    ...
    func _queue{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        targets_len: felt,
        targets: felt*,
        values_len: felt,
        values: felt*,
